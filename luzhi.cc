...
int main(int argc, char **argv)
{
	...
	*/
	...
	const std::string model_path = "/home/auto/cpp_OpenVINO_yolov8/RM_pose.onnx";
	...
	double result = 0;
	  ...
	  // 创建 VideoWriter 对象，使用 MJPG 编解码器，帧率为 30
    cv::VideoWriter video("output.avi", cv::VideoWriter::fourcc('M','J','P','G'), 30, cv::Size(1280, 1024));
    if (!video.isOpened()) {
        std::cerr << "Error: Could not create the video file." << std::endl;
        return -1;
    }
